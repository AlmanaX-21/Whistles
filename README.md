# Create: Train Whistles

Add a new whistle system to the train with a UI element on which you pull to play the whistle or the horn.

## Config Options

- **Pitch Range** — how far the pitch bends either way from the lever, in semitones.
- **Master Volume** — overall volume multiplier for all whistle/horn sounds.
- **Hearing Range** — how far away the whistle/horn can be heard, in blocks.
